<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="mb-3">
            <x-input-label for="update_password_current_password" class="form-lavel" :value="__('Current Password')" />
        ...
        <div class="mb-3">
            <x-input-label for="update_password_password" class="form-lavel" :value="__('New Password')" />
        ...
        <div class="mb-3">
            <x-input-label for="update_password_password_confirmation" class="form-lavel" :value="__('Confirm Password')" />
