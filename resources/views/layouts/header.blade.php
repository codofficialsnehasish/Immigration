                            ...
                            <div class="search-list d-flex flex-column gap-2">
                                <div class="search-list-item d-flex align-items-center gap-3">
                                    <div class="memmber-img">
                                        <img src="{{ asset('dashboard_asset/assets/images/avatars/01.png') }}" width="32" height="32" class="rounded-circle" alt="">
                                    </div>
                                    <div class="">
                                ...
                                <div class="search-list-item d-flex align-items-center gap-3">
                                    <div class="memmber-img">
                                        <img src="{{ asset('dashboard_asset/assets/images/avatars/02.png') }}" width="32" height="32" class="rounded-circle" alt="">
                                    </div>
                                    <div class="">
                                ...
                                <div class="search-list-item d-flex align-items-center gap-3">
                                    <div class="memmber-img">
                                        <img src="{{ asset('dashboard_asset/assets/images/avatars/03.png') }}" width="32" height="32" class="rounded-circle" alt="">
                                    </div>
                                    <div class="">
        ...
        <ul class="navbar-nav ms-auto gap-1 nav-right-links align-items-center">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-apps shadow-lg d-none p-3">
                    ...
                    <div class="row row-cols-3 g-0 border-bottom">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/01.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/02.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/03.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                    ...
                    <div class="row row-cols-3 g-0 border-bottom">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/04.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/05.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/06.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                    ...
                    <div class="row row-cols-3 g-0 border-bottom">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/07.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/08.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/09.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                    ...
                    <div class="row row-cols-3 g-0">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/10.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/11.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
                        ...
                        <div class="app-wrapper d-flex flex-column gap-2 text-center">
                            <div class="app-icon">
                            <img src="{{ asset('dashboard_asset/assets/images/apps/12.png') }}" width="36" alt="">
                            </div>
                            <div class="app-name">
            ...
            <li class="nav-item dropdown">
                <a href="javascrpt:;" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
                    {{-- <img src="{{ !empty(Auth::user()->profile_image) ? asset(Auth::user()->profile_image) : asset('dashboard_asset/assets/images/avatars/01.png') }}" class="rounded-circle p-1 border" width="45" height="45" alt=""> --}}
                    <img src="{{ asset('assets/dashboard_asset/assets/images/avatars/11.png') }}" class="rounded-circle p-1 border" width="45" height="45" alt="">
                </a>
                <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                    <a class="dropdown-item  gap-2 py-2" href="javascript:;">
                    <div class="text-center">
                        {{-- <img src="{{ !empty(Auth::user()->profile_image) ? asset(Auth::user()->profile_image) : asset('dashboard_asset/assets/images/avatars/01.png') }}" class="rounded-circle p-1 shadow mb-3" width="90" height="90"
                        alt=""> --}}
                        <img src="{{ asset('assets/dashboard_asset/assets/images/avatars/11.png') }}" class="rounded-circle p-1 shadow mb-3" width="90" height="90"
                        alt="">
