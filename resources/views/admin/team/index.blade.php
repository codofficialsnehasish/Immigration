...
<!--start main wrapper-->
    ...
    <div class="main-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Team's</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                                    ...
                                    @foreach ($teams as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('team.destroy', $item->id) }}" onsubmit="return confirm('Are you sure?')" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="description" class="form-control" id="description" style="min-height: 150px !important;" placeholder="Enter Description"></textarea>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        </div>
        ...
        <div class="modal fade modal-lg" id="staticBackdropedit{{ $team->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Edit Team Member</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $team->name }}" id="service-name" placeholder="Enter Service Name" required="">
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="position" class="form-label">Position</label>
                            <input type="text" name="position" class="form-control" id="position" value="{{ $team->position }}" placeholder="Enter Position" required="">
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea type="text" name="description" class="form-control" id="description" style="min-height: 150px !important;" placeholder="Enter Description">{{ $team->description }}</textarea>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        </div>
                        <div>
                            <div class="mb-3">
                                <img class="img-thumbnail rounded me-2" id="blahedit" alt="" width="200" src="{{ asset($team->image) }}" data-holder-rendered="true" style="display: {{ !empty($item->image) ? 'block' : 'none' }};">
                            </div>
                            <div class="mb-3">
                                <label for="imgInpedit" class="form-label">Image</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label mb-3 d-flex">Visibility</label>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="customRadioInline1" name="is_visible" class="form-check-input" value="1" @if($team->is_visible == 1) checked @endif>
                                <label class="form-check-label" for="customRadioInline1">Visible</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" id="customRadioInline2" name="is_visible" class="form-check-input" value="0" @if($team->is_visible == 0) checked @endif>
                                <label class="form-check-label" for="customRadioInline2">Invisible</label>
                            </div>
                        </div>
                    </div>
