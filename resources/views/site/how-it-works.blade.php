            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-6 col-sm-12 chooseus-block">
                    <div class="chooseus-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="link-btn">
                                <a href="javascript:void(0);"><span>Check Your Eligibility Now</span><i class="icon-9"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 chooseus-block">
                    <div class="chooseus-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="icon-box d-flex justify-content-center"><img src="{{ asset('assets/site-assets/images/icons/icon-4.png') }}" alt=""></div>
